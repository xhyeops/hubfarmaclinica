...
const farmacos = [
  {
    id: "losartana",
    nome: "Losartana",
    classe: "Bloqueador do Receptor de Angiotensina II",
...
export default function FarmacosPage() {
  ...
  const farmacosFiltrados = farmacos.filter(f => 
    f.nome.toLowerCase().includes(busca.toLowerCase()) ||
    f.classe.toLowerCase().includes(busca.toLowerCase()) ||
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
          ...
          {farmacosFiltrados.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-medium text-foreground mb-1">Nenhum fármaco encontrado</h3>
